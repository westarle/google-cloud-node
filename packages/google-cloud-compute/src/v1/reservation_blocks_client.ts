...
export class ReservationBlocksClient {
    ...
    this.reservationBlocksStub = this._gaxGrpc.createStub(
      this._opts.fallback
        ...
        : // eslint-disable-next-line @typescript-eslint/no-explicit-any
          (this._protos as any).google.cloud.compute.v1.ReservationBlocks,
      this._opts,
      this._providedCustomServicePath,
   ...
   */
  get(
    request?: protos.google.cloud.compute.v1.IGetReservationBlockRequest,
    options?: CallOptions,
  ): Promise<
    [
  ...
  get(
    ...
    callback: Callback<
      protos.google.cloud.compute.v1.IReservationBlocksGetResponse,
      | protos.google.cloud.compute.v1.IGetReservationBlockRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  getIamPolicy(
    ...
    [
      ...
      (
        | protos.google.cloud.compute.v1.IGetIamPolicyReservationBlockRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   */
  performMaintenance(
    request?: protos.google.cloud.compute.v1.IPerformMaintenanceReservationBlockRequest,
    options?: CallOptions,
  ): Promise<
    [
  ...
  performMaintenance(
    ...
    callback: Callback<
      ...
      | protos.google.cloud.compute.v1.IPerformMaintenanceReservationBlockRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  setIamPolicy(
    ...
    [
      protos.google.cloud.compute.v1.IPolicy,
      (
        | protos.google.cloud.compute.v1.ISetIamPolicyReservationBlockRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  testIamPermissions(
    ...
    [
      ...
      (
        | protos.google.cloud.compute.v1.ITestIamPermissionsReservationBlockRequest
        | undefined
      ),
      {} | undefined,
    ]
   ...
   */
  list(
    request?: protos.google.cloud.compute.v1.IListReservationBlocksRequest,
    options?: CallOptions,
  ): Promise<
    [
  ...
  list(
    ...
    callback: PaginationCallback<
      protos.google.cloud.compute.v1.IListReservationBlocksRequest,
      | protos.google.cloud.compute.v1.IReservationBlocksListResponse
      | null
      | undefined,
      protos.google.cloud.compute.v1.IReservationBlock
  ...
  listAsync(
    request?: protos.google.cloud.compute.v1.IListReservationBlocksRequest,
    options?: CallOptions,
  ): AsyncIterable<protos.google.cloud.compute.v1.IReservationBlock> {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.list.asyncIterate(
      ...
      request as {},
      callSettings,
    ) as AsyncIterable<protos.google.cloud.compute.v1.IReservationBlock>;
  }
