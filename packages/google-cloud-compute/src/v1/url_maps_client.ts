...
export class UrlMapsClient {
  ...
  delete(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.compute.v1.IOperation,
          | protos.google.cloud.compute.v1.IDeleteUrlMapRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  insert(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.compute.v1.IOperation,
          | protos.google.cloud.compute.v1.IInsertUrlMapRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  invalidateCache(
    ...
    callback: Callback<
      protos.google.cloud.compute.v1.IOperation,
      | protos.google.cloud.compute.v1.IInvalidateCacheUrlMapRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
   *   for more details and examples.
   * @example <caption>include:samples/generated/v1/url_maps.test_iam_permissions.js</caption>
   * region_tag:compute_v1_generated_UrlMaps_TestIamPermissions_async
   */
  testIamPermissions(
    request?: protos.google.cloud.compute.v1.ITestIamPermissionsUrlMapRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.compute.v1.ITestPermissionsResponse,
      (
        | protos.google.cloud.compute.v1.ITestIamPermissionsUrlMapRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  update(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.compute.v1.IOperation,
          | protos.google.cloud.compute.v1.IUpdateUrlMapRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  validate(
    ...
    optionsOrCallback?:
      ...
      | Callback<
          protos.google.cloud.compute.v1.IUrlMapsValidateResponse,
          | protos.google.cloud.compute.v1.IValidateUrlMapRequest
          | null
          | undefined,
          {} | null | undefined
        >,
  ...
  aggregatedListAsync(
    ...
    [string, protos.google.cloud.compute.v1.IUrlMapsScopedList]
  > {
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
