...
export class SnapshotSettingsServiceClient {
   ...
   */
  get(
    request?: protos.google.cloud.compute.v1beta.IGetSnapshotSettingRequest,
    options?: CallOptions,
  ): Promise<
    [
  ...
  get(
    ...
    callback: Callback<
      protos.google.cloud.compute.v1beta.ISnapshotSettings,
      | protos.google.cloud.compute.v1beta.IGetSnapshotSettingRequest
      | null
      | undefined,
      {} | null | undefined
    >,
   ...
   */
  patch(
    request?: protos.google.cloud.compute.v1beta.IPatchSnapshotSettingRequest,
    options?: CallOptions,
  ): Promise<
    [
  ...
  patch(
    ...
    callback: Callback<
      ...
      | protos.google.cloud.compute.v1beta.IPatchSnapshotSettingRequest
      | null
      | undefined,
      {} | null | undefined
    >,
